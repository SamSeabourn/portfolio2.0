...
const TopSplash = () => {
  ...
  const changeBrushSelection = (e) => {
    ...
    if (color1Tin != null && color2Tin != null ){
      ...
      selectedColor = color
      updateBrush(color)
      color1Tin.classList.remove("flash")
      color2Tin.classList.remove("flash")
  ...
  return (
    ...
    <g>
      ...
      <path id="selectColor2" data-color="2" className="selectColor" onClick={ changeBrushSelection } d="M33.737,322.673c-.931-9.559-21.965-9.244-22.621.007a6.3,6.3,0,0,0,.029.707l-.06,21.238c-.154,1.96,2.045,4.291,4.449,5.221,5.571,2.24,13.909,2.135,17.646-3.211.957.159.431-23.516.583-24.277C33.763,322.463,33.746,322.568,33.737,322.673Z" transform="translate(-0.172 0.1)" style={{ fill: "rgba(0,0,0,0)" }} />
