...
const Project = (props) => {
  ...
  const guid = () => {
    //React warning says that eveything needs a key as it could be breaking in the future
    function _p8(s) {
        ...
        <div className="project-columns">
          <div className="project-text">
            <h2
              ...
              style={setTitleColor(props.nightMode)}
            >
              {projectName}
            </h2>
            ...
            <section
              style={{ textAlign: "left", margin: "0em 2em 0em -0.5em" }}
            >
              {githubButton()}
              {urlButton()}
            </section>
  ...
  return (
    <div
      ...
      className="project"
      style={setBackgroundColor(props.nightMode)}
    >
      {view()}
    </div>
  );
